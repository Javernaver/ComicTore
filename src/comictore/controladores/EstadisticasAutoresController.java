 ...
 * @author javie
 */
public class EstadisticasAutoresController implements Initializable {
    ...
    public void asignarValores() {
        ...
        ArrayList<Autor> autores = Colecciones.getAutores().getAutores();
        ...
        for (Autor autor: autores) {
            ...
            switch ((int)autor.getComics().largo() / 10 ) {
